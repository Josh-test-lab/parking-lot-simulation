...
#處理上下午問卷資料
day_df = pd.read_excel('C:/Users/Applied Math NDHU/Downloads/day.xlsx')
night_df = pd.read_excel('C:/Users/Applied Math NDHU/Downloads/night.xlsx')
...
merdf.to_excel(r'C:/Users/Applied Math NDHU/Downloads/mergedf.xlsx',index=False)

#處理軒哥觀察資料
df = pd.read_excel('C:/Users/Applied Math NDHU/Downloads/mergedf.xlsx')
data2 = pd.read_excel('C:/Users/Applied Math NDHU/Downloads/observe.xlsx')
drop_df = data2.drop(['日期','對應車種車次','方向','出站人數',	'進站人數','學生',	'其它人士'
,'期望步行','期望單車','期望機車','期望汽車','停車場汽車數量','停車場機車數量','停車場單車數量','機車格','汽車格'],axis=1)
mapdf = drop_df.to_excel(r'C:/Users/Applied Math NDHU/Downloads/mapdf.xlsx',index=False)

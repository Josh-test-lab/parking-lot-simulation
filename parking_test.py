...
while True:
    ...
    if new_car > 0:
        ...
        print(f'{'car_parked': <{20}}, {'remain_car_parking_space': <{35}}, {'car_cannot_park': <{28}}= {[car_parked, remain_car_parking_space, car_cannot_park]}')
    else:
        new_car = -new_car
        ...
        print(f'{'car_parked': <{20}}, {'remain_car_parking_space': <{35}}, {'car_left_failed': <{28}} = {[car_parked, remain_car_parking_space, car_left_failed]}')
    ...
    if new_motorcycle > 0:
        ...
        print(f'{'motorcycle_parked': <{20}}, {'remain_motorcycle_parking_space': <{35}}, {'motorcycle_cannot_park': <{28}} = {[motorcycle_parked, remain_motorcycle_parking_space, motorcycle_cannot_park]}')
    else:
        ...
        print(f'{'motorcycle_parked': <{20}}, {'remain_motorcycle_parking_space': <{35}}, {'motorcycle_left_failed': <{28}} = {[motorcycle_parked, remain_motorcycle_parking_space, motorcycle_left_failed]}')
    ...
    if new_bicycle > 0:
        ...
        print(f'{'bicycle_parked': <{20}}, {'remain_motorcycle_parking_space': <{35}}, {'bicycle_cannot_park': <{28}} = {[bicycle_parked, remain_motorcycle_parking_space, bicycle_cannot_park]}')
    else:
        ...
        print(f'{'bicycle_parked': <{20}}, {'remain_motorcycle_parking_space': <{35}}, {'bicycle_left_failed': <{28}} = {[bicycle_parked, remain_motorcycle_parking_space, bicycle_left_failed]}')

...
def bicycle_parked_in_motorcycle_space_event(new_bicycle, bicycle_parked, motorcycle_parked, remain_motorcycle_parking_space, max_motorcycle_parking_space, max_bicycle_parked_in_a_motorcycle_space = 2):
    bicycle_cannot_park = 0
    if new_bicycle == 0:
        return bicycle_parked, remain_motorcycle_parking_space, bicycle_cannot_park
    ...
    occupied_number = bicycle_parked + max_bicycle_parked_in_a_motorcycle_space * motorcycle_parked # multi- times of motorcycle_parked
    if occupied_number + new_bicycle <= max_bicycle_parked_in_a_motorcycle_space * max_motorcycle_parking_space:
        bicycle_parked += new_bicycle
    else:
        bicycle_cannot_park = max_bicycle_parked_in_a_motorcycle_space * max_motorcycle_parking_space - occupied_number - new_bicycle
        bicycle_parked += (new_bicycle - bicycle_cannot_park)
...
def bicycle_left_motorcycle_space_event(new_bicycle, bicycle_parked, motorcycle_parked, remain_motorcycle_parking_space, max_motorcycle_parking_space, max_bicycle_parked_in_a_motorcycle_space = 2):
    bicycle_left_failed = 0
    if new_bicycle == 0:
        return bicycle_parked, remain_motorcycle_parking_space, bicycle_left_failed
    if max_bicycle_parked_in_a_motorcycle_space == 1:
    ...
    if bicycle_parked >= new_bicycle:
        ...
        bicycle_left_failed = (new_bicycle - bicycle_parked)
        bicycle_parked -= (new_bicycle - bicycle_left_failed)
